#!/usr/bin/env python3
########################### Set Velocity (no interpolation mode) #########################################

import rospy
from iiwa_msgs.msg import CartesianPose
from tf.transformations import euler_from_quaternion, quaternion_from_euler
from geometry_msgs.msg import PoseStamped, Point, Quaternion
from iiwa_msgs.srv import SetSmartServoJointSpeedLimits, SetSmartServoLinSpeedLimitsRequest, SetSmartServoLinSpeedLimitsResponse
...
try:
    ...
    resp = set_vel(joint_relative_velocity= 0.0,joint_relative_acceleration= 0.0, override_joint_acceleration=0.0) 
    #print("RR", resp0.success)
